...
export const CONFIG_APP = {
    ...
    description:
        'Obtenha valores de grandezas elétricas, calculando valor RMS e pico aplicado em alto falantes ou amplificadores.',
    keywords: [
        ...
        'Análise de Potência',
        'Potência de Áudio',
        'Potência de Amplificação para Automóveis',
